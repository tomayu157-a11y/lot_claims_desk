...
DATASETS: dict[str, Dataset] = {
    ...
    "icd10pcs": Dataset(
        key="icd10pcs",
        label="CMS ICD-10-PCS Code File",
        patterns=("icd10pcs_codes_*.txt", "icd10pcs_order_*.txt", "icd10pcs*.txt"),
        code_columns=("code", "icd10pcs", "procedure_code"),
        text_columns=("long_description", "description", "title"),
        citation_url="https://www.cms.gov/medicare/coding-billing/icd-10-codes",
        notes="Inpatient procedure codes: transplant, CAR-T. Fetched by the rules stage.",
    ),
    "asp_crosswalk": Dataset(
        key="asp_crosswalk",
        label="CMS ASP NDC-HCPCS Crosswalk",
        patterns=("asp_ndc_hcpcs_crosswalk_*.csv",),
        code_columns=("hcpcs", "ndc", "code"),
        text_columns=("drug_name", "short_description", "labeler_name"),
        citation_url="https://www.cms.gov/medicare/payment/part-b-drugs/asp-pricing-files",
        notes="Which NDCs bill under which HCPCS code. Fetched by the rules stage.",
    ),
    "gems": Dataset(
        key="gems",
